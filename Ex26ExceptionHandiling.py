...
### Summary:
# - You can handle multiple exceptions using multiple 'except' blocks or by combining exception in a tuple.
...
# - except: can be excluded if you have a finally block.
